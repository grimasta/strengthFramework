...
public class WithoutCommitPrime_old {

	DataRepository dataRepository;
	Map<String, Map<String, Map<String, Float>>> coTimeDifference = new HashMap<>();
	Logger logger = LoggerFactory.getLogger(WithoutCommitPrime_old.class);

	public WithoutCommitPrime_old() {
